    ...
    <div class="container">
      ...
      <p class="lede lede--gap" data-reveal>Fotografia real das unidades onde nossos projetos
        ...
        <button class="pfx__item" type="button"
          data-gallery="assets/img/portfolio/vydea/01.webp|assets/img/portfolio/vydea/08.webp|assets/img/portfolio/vydea/09.webp"
          data-title="RACE BOOTCAMP" data-seg="Clube e fitness . Balneário Camboriú/SC"
          aria-label="Abrir galeria de 3 fotos: RACE BOOTCAMP">
          ...
          <span class="pfx__veil" aria-hidden="true"></span>
            ...
            <span class="pfx__view"><svg class="pfx__view-i" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" aria-hidden="true"><rect x="8" y="3" width="13" height="13" rx="1.6"/><path d="M16 20H5a2 2 0 0 1-2-2V7"/></svg>Ver galeria · 3 fotos</span>
          </span>
        </button>
        <button class="pfx__item" type="button"
        ...
        <button class="pfx__item" type="button"
          data-gallery="assets/img/portfolio/festval-batel/01.webp|assets/img/portfolio/festval-batel/08.webp|assets/img/portfolio/festval-batel/09.webp"
          data-title="Festval Batel" data-seg="Supermercado . Curitiba/PR"
          aria-label="Abrir galeria de 3 fotos: Festval Batel">
