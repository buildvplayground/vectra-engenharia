...
<main id="conteudo">
  ...
  <section class="hero" aria-labelledby="h-hero">
    ...
    <div class="container hero__in">
      ...
      <p class="hero__sub" data-reveal>Engenharia de instalações para incorporadoras e construtora.
        Um responsável do primeiro estudo preliminar à finalização da obra.</p>
  ...
  <section class="sec" id="atuacao" aria-labelledby="h-atuacao">
    <div class="container">
      ...
      <p class="lede lede--gap" data-reveal>Disciplinas espalhadas por fornecedores desconexos
        geram conflito, retrabalho e atraso. Atraso no lançamento custa faturamento e imagem de
        marca. A Vectra concentra todas as disciplinas de instalações em um único projeto,
        compatibilizado em BIM antes da execução.</p>
      ...
      <div class="frentes">
        <div class="frente" data-reveal data-rv="left">
          ...
          <p>Engenharia multidisciplinar integrada, de ponta a ponta: do estudo preliminar à
            documentação executiva, com um único fornecedor para todas as disciplinas.</p>
        ...
        <div class="frente" data-reveal data-rv="right">
          ...
          <p>Cada disciplina é modelada e cruzada digitalmente em BIM, com quantitativos
            vinculados ao modelo. O conflito que só apareceria depois é identificado e resolvido
            ainda em projeto e não em obra.</p>
  ...
  <section class="jor sec--dark" id="jornada" aria-labelledby="h-jor">
    ...
    <div class="jor__layers" aria-hidden="true">
      <img src="<?php echo esc_url( VECTRA_URI . '/assets/img/segmentos-bg.webp' ); ?>" alt="" loading="lazy" decoding="async" width="2400" height="1600" data-para="0.07">
    ...
    <div class="container">
      ...
      <p class="lede lede--gap" data-reveal>Fotografia real das unidades onde nossos projetos
        ...
        <button class="pfx__item" type="button"
          data-gallery="assets/img/portfolio/vydea/01.webp|assets/img/portfolio/vydea/02.webp|assets/img/portfolio/vydea/03.webp|assets/img/portfolio/vydea/04.webp|assets/img/portfolio/vydea/05.webp|assets/img/portfolio/vydea/07.webp|assets/img/portfolio/vydea/08.webp|assets/img/portfolio/vydea/09.webp"
          data-title="RACE BOOTCAMP" data-seg="Clube e fitness . Balneário Camboriú/SC"
          aria-label="Abrir galeria de 8 fotos: RACE BOOTCAMP">
          <span class="pfx__media"><img src="<?php echo esc_url( VECTRA_URI . '/assets/img/portfolio/vydea/01.webp' ); ?>" alt="Clube e fitness RACE BOOTCAMP, Balneário Camboriú/SC" loading="lazy" decoding="async" width="1920" height="1281" data-para="0.6"></span>
          <span class="pfx__veil" aria-hidden="true"></span>
                    <span class="pfx__cap">
            <span class="pfx__t">RACE BOOTCAMP</span>
        ...
        <button class="pfx__item" type="button"
          data-gallery="assets/img/portfolio/smartfit-uberaba/01.webp"
          data-title="Smart Fit Uberaba" data-seg="Academia . Uberaba/MG"
          aria-label="Abrir galeria de 1 foto: Smart Fit Uberaba">
          <span class="pfx__media"><img src="<?php echo esc_url( VECTRA_URI . '/assets/img/portfolio/smartfit-uberaba/01.webp' ); ?>" alt="Academia Smart Fit Uberaba, Uberaba/MG" loading="lazy" decoding="async" width="1920" height="1080" data-para="0.6"></span>
          <span class="pfx__veil" aria-hidden="true"></span>
                    <span class="pfx__cap">
            <span class="pfx__t">Smart Fit Uberaba</span>
            <span class="pfx__view"><svg class="pfx__view-i" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" aria-hidden="true"><rect x="8" y="3" width="13" height="13" rx="1.6"/><path d="M16 20H5a2 2 0 0 1-2-2V7"/></svg>Ver galeria · 1 foto</span>
          </span>
        </button>
        <button class="pfx__item" type="button"
          data-gallery="assets/img/portfolio/festval-batel/01.webp|assets/img/portfolio/festval-batel/02.webp|assets/img/portfolio/festval-batel/03.webp|assets/img/portfolio/festval-batel/04.webp|assets/img/portfolio/festval-batel/05.webp|assets/img/portfolio/festval-batel/07.webp|assets/img/portfolio/festval-batel/08.webp|assets/img/portfolio/festval-batel/09.webp"
          data-title="Festval Batel" data-seg="Supermercado . Curitiba/PR"
          aria-label="Abrir galeria de 8 fotos: Festval Batel">
        ...
        <button class="pfx__item" type="button"
          data-gallery="assets/img/portfolio/jockey-plaza/01.webp|assets/img/portfolio/jockey-plaza/02.webp|assets/img/portfolio/jockey-plaza/03.webp|assets/img/portfolio/jockey-plaza/04.webp|assets/img/portfolio/jockey-plaza/05.webp|assets/img/portfolio/jockey-plaza/06.webp|assets/img/portfolio/jockey-plaza/07.webp|assets/img/portfolio/jockey-plaza/09.webp"
          data-title="Jockey Plaza" data-seg="Shopping . Curitiba/PR"
          aria-label="Abrir galeria de 8 fotos: Jockey Plaza">
